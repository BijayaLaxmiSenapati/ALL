				...
				<table style="width: 50%">
					<tr>
						...
						<td><input type="text" name="fname" required
							placeholder="Enter your fisrt name"></input></td>
					</tr>
					...
					<tr>
						...
						<td><input type="tel" name="mobile" maxlength="10"
							title="only 10 digits" required placeholder="123-456-7890"></input></td><!-- pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" -->
					</tr>
					...
					<tr>
						...
						<td><input type="password" name="repassword"
							title="Same as above password" required placeholder></td>
					</tr>
				</table>
				<br>
