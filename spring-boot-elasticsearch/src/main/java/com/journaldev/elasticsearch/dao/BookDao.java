...
public class BookDao {
	...
	/*
	 * public Book insertBook(Book book){ book.setId(UUID.randomUUID().toString());
	 ...
	 * .source(dataMap); try { IndexResponse response =
	 * restHighLevelClient.index(indexRequest); } catch(ElasticsearchException e) {
	 * e.getDetailedMessage(); } catch (java.io.IOException ex){
	 * ex.getLocalizedMessage(); } return book; }
	 */
